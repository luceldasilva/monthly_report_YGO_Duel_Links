CREATE TABLE IF NOT EXISTS kog_2025_mar (
    ...
    CONSTRAINT fk_kog_2025_feb_player_id 
        FOREIGN KEY (player_id) 
        REFERENCES players (player_id),
    CONSTRAINT fk_kog_2025_feb_deck_id 
        FOREIGN KEY (deck_id) 
        REFERENCES decks (deck_id),
    CONSTRAINT fk_kog_2025_feb_skill_id
        FOREIGN KEY (skill_id)
        REFERENCES skills (skill_id),
	CONSTRAINT fk_kog_2025_feb_date_id
        FOREIGN KEY (date_id)
