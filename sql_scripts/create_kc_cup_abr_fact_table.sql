CREATE TABLE IF NOT EXISTS kc_cup_2025_april (
...
GRANT SELECT, INSERT, UPDATE, TRUNCATE, REFERENCES, TRIGGER ON kc_cup_2025_april TO usuario_que_usas;

ALTER TABLE kc_cup_2025_april OWNER TO usuario_que_usas;